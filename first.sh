...
#service tor restart
cd
wget https://raw.githubusercontent.com/budz87/doubletorvpn/main/middlebox.sh
...
patch_tcp(){
wget https://raw.githubusercontent.com/budz87/doubletorvpn/main/patch_tcp_debian.sh
